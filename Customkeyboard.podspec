#
#  Be sure to run `pod spec lint Customkeyboard.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                A simple and fast realization of a custom digital keyboard. There is always a keyboard for you.
                   DESC
  ...
  s.source       = { :git => "https://github.com/ChinaHackers/CustomKeyboard.git", :tag => "#{s.version}" }
